...
exports.SearchBookController = void 0;
...
//   body: T
// }
var SearchBookController = /** @class */ (function () {
    function SearchBookController(searchBookUseCase) {
        this.searchBookUseCase = searchBookUseCase;
    }
    SearchBookController.prototype.handle = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var httpRequest, searchThoseBooks, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.searchBookUseCase.handle(httpRequest.body)];
                    case 1:
                        searchThoseBooks = _a.sent();
